...
INPUTS = ['FNO.py']
OUTPUTS = ['FNO_laminar.pth', 'FNO_laminar.png']

run = Simvue()

run.init(folder="/HPC-AI/laminar", tags=['OpenFOAM', 'Laminar', 'Surrogate', 'FNO'], metadata=configuration)
...
# %%
data =  np.load(os.getcwd()+ '/NS_laminar.npz')
...
torch.save(model.state_dict(), 'FNO_laminar.pth')
