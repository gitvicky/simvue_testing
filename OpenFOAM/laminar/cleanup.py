...
INPUTS = []
OUTPUTS = ['Data/NS_laminar.npz', 'Data/Re_Values.npy']

run = Simvue()

run.init(folder="/HPC-AI/laminar", tags=['OpenFOAM', 'Laminar', 'Processing', 'Cleanup'])
...
np.savez(data_loc + '/NS_laminar', U=u_list, V=v_list, P = p_list, x=xi[1:-1], y=yi[1:-1],t=t)
