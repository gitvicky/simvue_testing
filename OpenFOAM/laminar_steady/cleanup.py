...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 24 20:30:20 2021cd.np
...
INPUTS = []
OUTPUTS = ['Data/NS_laminar_steady.npz', 'Data/Re_Values.npy']

run = Simvue()

run.init(folder="/HPC-AI/laminar", tags=['OpenFOAM', 'Laminar', 'Steady' 'Processing', 'Cleanup'])
...
np.savez(data_loc + '/NS_laminar_steady', U=u_list, V=v_list, P = p_list, x=xi[1:-1], y=yi[1:-1],t=t)
