...
# %%
num_sims = 50
lb = np.asarray([0.00002]) # length, width
ub = np.asarray([0.000002]) # length, width
...
subprocess.call(["cp", data_loc + '/cleanup.py', data_loc + '/Data'])
